...
// --- DATA ---
const skinData = [];
const colorList = ["#ff5722", "#2196f3", "#4caf50", "#9c27b0", "#ffcc00", "#1de9b6", "#ffffff", "rainbow", "void", "#ff1744", "#00e676", "#7c4dff", "#d4e157", "#ff7043", "#26c6da", "#ec407a", "#ffeb3b", "#009688", "#795548", "#607d8b", "#f44336", "#e91e63", "#673ab7", "#3f51b5", "#03a9f4", "#00bcd4", "#009688", "#8bc34a", "#cddc39", "#ffeb3b", "#ffc107", "#ff9800"];
