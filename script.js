...
function updateUI() {
    ...
    ids.forEach((id,i) => {
        ...
        if(highScore >= unlocks[i]){
            ...
            btn.onclick = () => selectSkin(id, unlocks[i]);
        } else {
        ...
        if(playerColor === getSkinColor(id)) btn.classList.add("selected");
...
function getSkinColor(id){
    switch(id){
        case "skin-orange": return "#ff5722";
        case "skin-blue": return "#2196f3";
        case "skin-green": return "#4caf50";
        case "skin-purple": return "#9c27b0";
        case "skin-gold": return "#ffcc00";
        case "skin-mint": return "#1de9b6";
        case "skin-striped": return "striped";
        case "skin-camo": return "camo";
        case "skin-ghost": return "ghost";
        case "skin-lava": return "lava";
        case "skin-rainbow": return "rainbow";
        case "skin-neon": return "neon";
        case "skin-diamond": return "diamond";
        case "skin-ruby": return "ruby";
        case "skin-emerald": return "emerald";
        case "skin-void": return "void";
    }
}

function selectSkin(id, req){
    if(highScore >= req){
        playerColor = getSkinColor(id);
        updateUI();
    }
}
